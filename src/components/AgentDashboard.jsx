...
const AgentDashboard = ({
  ...
  const superuserEmail = process.env.REACT_APP_SUPERUSER_EMAIL;
  const isSuperUser = superuserEmail === user.email;
  return (
            ...
            <div className="flex items-center space-x-3 sm:space-x-4">
              ...
              {isSuperUser && (
                <button
                  ...
                  className="bg-gray-600 hover:bg-gray-700 text-white px-3 sm:px-4 py-1.5 sm:py-2 rounded-lg transition-colors text-sm sm:text-base flex items-center justify-center"
                >
                  {/* Icon for mobile */}
                  <svg
                    className="w-4 h-4 sm:hidden"
