...
const PublicView = ({
  ...
  <div>
    <h1 className="text-xl sm:text-2xl font-bold text-white">RC Real Estate</h1>
    <p className="text-gray-400 text-xs sm:text-sm">Catálogo de Propiedades</p>
  </div>
  <a
    href="/login"
          ...
          <div className="lg:col-span-1 space-y-8 glass-panel rounded-2xl backdrop-blur-lg border border-white/10 shadow-2xl">
            <div className="p-6">
              <div className="text-center mb-6">
                {/* <h2 className="text-xl font-bold text-white mb-2">🔍 Buscar Propiedades</h2> */}
                {/* <p className="text-gray-400 text-sm">Filtra por tus preferencias</p> */}
              </div>
